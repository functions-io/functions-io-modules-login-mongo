...
module.exports = function(message){
    return new Promise(async function (resolve, reject){
        try {
            ...
            let db = client.db(module.exports.config.db_name);

            db.collection(module.exports.config.db_collection_name).findOne({name:message.username}).then(function(record){
                try {
                    if (record){
